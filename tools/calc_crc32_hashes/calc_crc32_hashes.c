  ...
  while (pcap_next_ex(pcap_descr, &pkt_hdr, &pkt) == 1) { // rc 1 => done
    ...
    if (ip_version == 4) {
      if ((ip_proto == 6) || (ip_proto == 17)) {
        uint8_t data[12];
        *((uint32_t *)(data)) = ipv4_saddr;
        *((uint32_t *)(data + 4)) = ipv4_daddr;
        *((uint16_t *)(data + 8)) = l4_sport;
        *((uint16_t *)(data + 10)) = l4_dport;
        hash_val = crc32(data, 12);
      } else {
        uint8_t data[8];
        *((uint32_t *)(data)) = ipv4_saddr;
        *((uint32_t *)(data + 4)) = ipv4_daddr;
        hash_val = crc32(data, 8);
      }
    } else if (ip_version == 6) {
      if ((ip_proto == 6) || (ip_proto == 17)) {
        uint8_t data[36];
        *((uint32_t *)(data + 0)) = ntohl(*(((uint32_t *)ipv6_saddr) + 0));
        *((uint32_t *)(data + 4)) = ntohl(*(((uint32_t *)ipv6_saddr) + 1));
        *((uint32_t *)(data + 8)) = ntohl(*(((uint32_t *)ipv6_saddr) + 2));
        *((uint32_t *)(data + 12)) = ntohl(*(((uint32_t *)ipv6_saddr) + 3));
        *((uint32_t *)(data + 16)) = ntohl(*(((uint32_t *)ipv6_daddr) + 0));
        *((uint32_t *)(data + 20)) = ntohl(*(((uint32_t *)ipv6_daddr) + 1));
        *((uint32_t *)(data + 24)) = ntohl(*(((uint32_t *)ipv6_daddr) + 2));
        *((uint32_t *)(data + 28)) = ntohl(*(((uint32_t *)ipv6_daddr) + 3));
        *((uint16_t *)(data + 32)) = l4_sport;
        *((uint16_t *)(data + 34)) = l4_dport;
        hash_val = crc32(data, 36);
      } else {
        uint8_t data[32];
        *((uint32_t *)(data + 0)) = ntohl(*(((uint32_t *)ipv6_saddr) + 0));
        *((uint32_t *)(data + 4)) = ntohl(*(((uint32_t *)ipv6_saddr) + 1));
